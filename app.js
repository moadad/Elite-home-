...
const APP_SW_VERSION = 'elitehome-production-ultra-v11';
...
function renderCart() {
  ...
  if (!state.cart.length) {
    el.cartItems.innerHTML = '<div class="cart-item cart-item-empty"><div class="cart-empty-visual"><i class="fa-solid fa-bag-shopping"></i><strong>السلة فارغة</strong><span class="muted">ابدأ بإضافة المنتجات ثم أكمل الطلب.</span></div></div>'; 
