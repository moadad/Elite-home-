...
function renderCart() {
  ...
  if (el.cartScreenTotalText) el.cartScreenTotalText.textContent = count ? `${count} عنصر داخل السلة` : 'جاهز للمراجعة';
  el.cartItems.innerHTML = '';
  if (!state.cart.length) {
    el.cartItems.innerHTML = '<div class="cart-item cart-item-empty"><div class="muted">السلة فارغة</div></div>';
