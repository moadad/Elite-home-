...
const APP_SW_VERSION = 'elitehome-production-ultra-v8';
...
function applyFilters() {
  ...
  let items = getVisibleProducts().filter((product) => {
    const haystack = `${product._searchText || ''} ${getProductMainCategory(product) || ''} ${getProductSubCategory(product)}`.toLowerCase();
