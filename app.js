...
function getSeriesQtyText(product) { return getPackQtyText(product, '1'); }

function getSeriesQtyNumber(product) { return getPackQtyNumber(product, 1); }
...
function getSeriesBasePrice(product) {
  ...
  return round2(toNumber(product?.priceDozen ?? product?.priceWholesale ?? product?.unitPrice ?? 0));
}
